// src/lib.rs
/*
 * Core library for WebhookTrigger
 */
...
#[derive(Debug)]
pub struct WebhookTriggerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebhookTriggerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebhookTrigger processing");
    
    let mut processor = WebhookTriggerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebhookTriggerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebhookTriggerProcessor::new(false);
